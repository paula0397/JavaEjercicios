...
public class Program {
    public static void main(String[] args) {
        ...
        Juego piedraPapelOTijera = new Juego();

        //tomo nombre de los dos jugadores
        Scanner scanner = new Scanner(System.in);
        System.out.println("Bienvenidos al juego piedra, papel o tijera");
        ...
        while (seguirJugando) {
            ...
            //definir ganador
            Integer resultado = piedraPapelOTijera.cualGana(jugadaJugador1, jugadaJugador2);
            if (resultado == 0){
